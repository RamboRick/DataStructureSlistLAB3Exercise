...
public class SList {
  ...
  */
  ...
  public static void main (String[] args) {
    ...
    //testAfterInsertEnd();
    SList testSList = new SList();
    testSList.insertFront(new Integer (12));
    testSList.insertFront(new Integer(9));
    testSList.insertFront(new Integer(6));
    System.out.println(testSList.toString());
    
    testSList.insertFront(new Integer(3));
    testSList.insertEnd(new Integer(15));
    System.out.println(testSList.toString());
  }
